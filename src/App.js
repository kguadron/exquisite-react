      ...
      <div className="App">
        <header className="App__header">
          ...
          <p className="App__intro-text">
            ...
            is a method by which a collection of words or 
            images is collectively assembled. Each collaborator 
            adds to a composition in sequence, either by following 
            a rule (e.g. "The adjective noun adverb verb the 
